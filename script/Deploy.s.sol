...
contract Deploy is Script {
    ...
    function _printOperatorInstructions(
        ...
        console2.log("            }");
        console2.log("");
        console2.log("2. Pre-mint 1 wei of GBPF to the burn address by performing an exact-output");
        console2.log("   mint swap for 1 wei GBPF. The deployer pays a few wei of USDS, and 1 wei");
        console2.log("   GBPF lands at the user. The user then transfers it to 0xdEaD.");
        console2.log("   This avoids the gbpfSupply == 0 revert on the first real mint.");
        console2.log("");
        console2.log("3. Seed swap: perform an exact-input mint swap of 1 USDS via the V4");
        console2.log("   PoolManager. The deployer receives the resulting GBPF (~0.8 GBPF).");
        console2.log("");
        console2.log("4. Burn the seed: transfer all GBPF held by the deployer to 0xdEaD.");
        console2.log("");
        console2.log("After step 4, the protocol is fully bootstrapped and open for use.");
        console2.log("");
